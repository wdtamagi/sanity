...
export const ListItem = styled.div<{listLevel: number; listStyle: 'bullet' | 'number'}>`
  &.pt-list-item {
    width: fit-content;
    position: relative;
    display: block;
    ...
    /*
    NOTE: It’s important to 'transform' in order to force refresh the ':before' and ':after'
    pseudo-elements in WebKit: https://stackoverflow.com/a/21947628/831480
    */
  ...
  &.pt-list-item-number > .pt-list-item-inner:before {
    ...
    /* Make sure space between number and text never shrinks */
    min-width: 1.5rem;
    /* Optical alignment */
    position: relative;
    top: 1px;
...
function getContentForListLevelAndStyle(level: number, style: 'bullet' | 'number') {
